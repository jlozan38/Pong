  ...
  methods: {
    ...
    draw(s) {
      ...
      s.ellipse(
        ...
        this.$store.state.yBall,
        this.$store.state.diameter,
        this.$store.state.diameter
      );
      ...
      if (
        this.$store.state.xBall < this.$store.state.diameter / 2 ||
        this.$store.state.xBall > s.width - this.$store.state.diameter / 2
      ) {
